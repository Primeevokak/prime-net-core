...
fn default_bypass_profiles() -> Vec<PacketBypassProfile> {
    #[cfg(target_os = "windows")]
    {
        let mut profiles = vec![
            // CATEGORY: CRITICAL / ROBUST (Top community configs)
            PacketBypassProfile {
                name: "robust-disorder-fake".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "1".to_owned(),
                    "--disorder".to_owned(), "1".to_owned(),
                    "--fake".to_owned(), "-1".to_owned(),
                    "--timeout".to_owned(), "10".to_owned(),
                ],
            },
            PacketBypassProfile {
                name: "robust-oob-fake".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "1".to_owned(),
                    "--oob".to_owned(), "1".to_owned(),
                    "--fake".to_owned(), "-1".to_owned(),
                    "--timeout".to_owned(), "10".to_owned(),
                ],
            },
            PacketBypassProfile {
                name: "robust-tlsrec-fake".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "1".to_owned(),
                    "--tlsrec".to_owned(), "1+s".to_owned(),
                    "--fake".to_owned(), "-1".to_owned(),
                    "--timeout".to_owned(), "10".to_owned(),
                ],
            },
            PacketBypassProfile {
                name: "robust-split-fake".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "1+s".to_owned(),
                    "--fake".to_owned(), "-1".to_owned(),
                    "--timeout".to_owned(), "10".to_owned(),
                ],
            },
            // CATEGORY: STANDARD FALLBACKS
            PacketBypassProfile {
            ...
            PacketBypassProfile {
                name: "balanced-combo".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "2".to_owned(),
                    "--tlsrec".to_owned(), "2".to_owned(),
                    "--timeout".to_owned(), "7".to_owned(),
                ],
            },
            PacketBypassProfile {
                name: "safe-split-1".to_owned(),
                args: vec![
                    "--port".to_owned(), find_free_port().to_string(),
                    "--split".to_owned(), "1".to_owned(),
                    "--timeout".to_owned(), "5".to_owned(),
    ...
    #[cfg(target_os = "linux")]
    {
        let mut profiles = vec![
            ...
            PacketBypassProfile {
                name: "tls-sni-fake".to_owned(),
                args: vec![
                    "--port".to_owned(),
                    find_free_port().to_string(),
                    "--fake".to_owned(),
                    "-1".to_owned(),
                    "--fake-tls-mod".to_owned(),
                    "rand".to_owned(),
                    "--fake-ttl".to_owned(),
                    "5".to_owned(),
                    "--timeout".to_owned(),

...
Актуализировано под состояние кода на `2026-03-07`.
...
- `docs/ARCHITECTURE.md` — архитектура pipeline, ML-маршрутизатор, DPI bypass, Bloom filter.
...
- `docs/TROUBLESHOOTING.md` — типовые проблемы и диагностика (включая Discord).
